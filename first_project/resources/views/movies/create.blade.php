...
<head>
<meta charset="UTF-8">
<title>Add Movie Form - Laravel 8 CRUD</title>
...
<input type="text" name="movie_name" id="name" class="form-control" placeholder="Movie Name">
@error('movie_name')
...
<input type="text" name="movie_description" id="desc" class="form-control" placeholder="Movie Description">
...
<input type="text" name="movie_genre" id="gen" class="form-control" placeholder="Movie Genre">
@error('movie_genre')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
